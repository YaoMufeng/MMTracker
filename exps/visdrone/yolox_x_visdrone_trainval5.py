...
root = "/hdd/yaomf/datas/visdrone"


means = (0.46655824,0.47814095,0.4559528)
stds = (0.23179757,0.21539772,0.21797319)
...
class Exp(MyExp):
    def __init__(self):
        ...
        self.train_ann = "trainval5.json"
        self.val_ann = "test-dev5.json"    # change to train.json when running on training set
