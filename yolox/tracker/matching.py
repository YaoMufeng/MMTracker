...
def diou_distance(atracks,btracks):
    ...
    dious = np.zeros((len(atlbrs0), len(btlbrs0)), dtype=np.float)
...
def giou_distance(atracks,btracks):
    ...
    gious = np.zeros((len(atlbrs0), len(btlbrs0)), dtype=np.float)
...
def ciou_distance(atracks,btracks):
    ...
    cious = np.zeros((len(atlbrs0), len(btlbrs0)), dtype=np.float)
...
def eiou_distance(atracks,btracks):
    ...
    eious = np.zeros((len(atlbrs0), len(btlbrs0)), dtype=np.float)
...
def corner_iou_distance(atracks,btracks):
    ...
    corner_ious = np.zeros((len(atlbrs0), len(btlbrs0)), dtype=np.float)
...
def center_distance(atracks,btracks,cross_len):
    ...
    center_dis = np.zeros((len(atlbrs0), len(btlbrs0)), dtype=np.float)
