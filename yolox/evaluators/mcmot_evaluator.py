...
# from yolox.tracker.my_mc_bytetracker import MyMCByteTracker
...
class MCMOTEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(progress_bar(self.dataloader)):
            ...
            img_file_arr = img_file_name[0].split('/')

            if "VisDrone2019-MOT" in img_file_arr[0] and "M" in img_file_arr[2]:

                video_name = img_file_arr[2].replace("_v","")
                # print(video_name)
                # ipdb.set_trace()
            else:
                video_name = img_file_arr[0]
